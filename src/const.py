...
TRAINING_POST_OPPONENT_DEATH_FRAMES = FPS * 3
...
HOSTILE_BOARDED_MARINE_CREW_LOSS_REWARD_FACTOR = 0.5
...
SHIP_TOOLTIP_ALPHA = 255
SHIP_TOOLTIP_WARNING_TEXT_COLOR = (155, 0, 0)

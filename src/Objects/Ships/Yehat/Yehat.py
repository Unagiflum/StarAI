...
import src.Objects.Ships.Yehat.YehatA1 as A1
import src.Objects.Ships.Yehat.YehatA2 as A2
import src.Objects.Ships.Yehat.YehatA3 as A3
import pygame
...
class Yehat(SpaceShip):
    ...
    def __init__(self, ship_name, player_num):
        ...
        if Yehat.shared_sprites is None:
            Yehat.shared_sprites = []
            for i in range(Const.SHIP_DIRECTIONS):  # Assuming 16 directions for the sprite
                ...
                Yehat.shared_sprites.append(pygame.image.load(str(sprite_path)).convert_alpha())

        # Use the shared sprites for this instance
        self.sprites = Yehat.shared_sprites

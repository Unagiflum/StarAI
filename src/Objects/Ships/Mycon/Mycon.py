...
import src.Objects.Ships.Mycon.MyconA1 as A1
import src.Objects.Ships.Mycon.MyconA2 as A2
import src.Objects.Ships.Mycon.MyconA3 as A3
import pygame
...
class Mycon(SpaceShip):
    ...
    def __init__(self, ship_name, player_num):
        ...
        if Mycon.shared_sprites is None:
            Mycon.shared_sprites = []
            for i in range(Const.SHIP_DIRECTIONS):  # Assuming 16 directions for the sprite
                ...
                Mycon.shared_sprites.append(pygame.image.load(str(sprite_path)).convert_alpha())

        # Use the shared sprites for this instance
        self.sprites = Mycon.shared_sprites

...
import src.Objects.Ships.Orz.OrzA3 as A3
import pygame
    ...
    def __init__(self, ship_name, player_num):
        ...
        if Orz.shared_sprites is None:
            ...
            for i in range(Const.SHIP_DIRECTIONS):  # Assuming 16 directions for the sprite
                ...
                Orz.shared_sprites.append(pygame.image.load(str(sprite_path)).convert_alpha())

        # Use the shared sprites for this instance
        self.sprites = Orz.shared_sprites
